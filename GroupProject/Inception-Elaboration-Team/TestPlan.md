...
|    1        | 1.3   | Click on Create New List button in Home Screen and input a list name incorporating non-English characters and special characters                               | When I go back to Home and click on the Lists the List should be present and the items should be displayed once I click on it.     | Test 1.2 completes successfully | ✅       |
...
|     12       | 12.2  | Go to the Item-list, when one can choose by inputting a name try retrieving items from an invalid type                                   | This is impossible since items must be retrieved by type                                                                                                                  | The inputted item-type does not exist | ✅       |
...
|    13        | 13.2  | Go to search for item, select an item and add it to a lists. Then go to the Show All Lists screen, click on the lists it was added to.      | The item has been added to the selected list                                                                                      | The list exists.           | ❌       |
