...
|----|----| 
| **Requirements** | Allow the user to create a new named list for organizing and tracking items.|
| **Pre-conditions** | User can use the app |
| **Post-conditions** | A new list with a specified name is created and presented in the lists screen. The list is empty and ready for items to be added. |
| **Scenarios** | **Normal:**<br>1. User clicks on the Create New List button on homepage.<br>2. The user enters a name for the list.<br>3. The system checks that the name is unique.<br>4. The system creates the list for the user.<br>**Alternate:**<br>1. The user enters an existing name. <br>2. The system prompts the user to enter a different name.<br>3. The user gives a new name and the system creates the list.<br>**Exceptional:** <br>1. The system encounters an issue while creating the list.<br>2. The system displays an error message and the user is prompted to try again later or contact customer support for assistance.<br>|
...
|----|----| 
| **Requirements** | Allow the user to permanently remove an existing list. | 
| **Pre-conditions** | User has some lists in the system they intend to delete. |
| **Post-conditions** | The selected list is removed and all the data in the list is no longer accessible.|
...
|----|----| 
| **Requirements** | Allow the user to choose their existing lists to perform actions such as editing, or deleting. | 
| **Pre-conditions** | User can access their previously created lists. |
...
| **Pre-conditions** | The User has at least one list created and has one list selected. |
| **Post-conditions** | The selected list has been opened and the user can view all the details. |
...
| **Scenarios** | **Normal:**<br>1. The user navigates to the database dashboard.<br>2. The user selects the option to create a new database entry.<br>3. The user enters the required information needed for the new item including its type.<br>4. The system checks the information.<br>5. The system adds the new item to the database.<br>**Exceptional:**<br>1. If the information the user enters is not complete or incorrect, the system displays an error message and requests the correct information.<br>2. If there is a system or database error during the process, the system prompts the user to try again.<br>|
...
|----|----| 
| **Requirements** | User is allowed to choose items in their grocery lists to perform the next operation, such as deleting. | 
